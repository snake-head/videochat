...
from models.grit_src.image_dense_captions import image_caption_api, init_demo, dense_pred_to_caption, \
...
class DenseCaptioning():
    ...
    def run_caption_tensor(self, img, video_path=None, index=0, images_path=None):
        # img = read_image(image_src, format="BGR")
        # print(img.shape)
        predictions, visualized_output = self.demo.run_on_image(img)
